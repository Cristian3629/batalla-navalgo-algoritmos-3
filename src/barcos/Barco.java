...
public abstract class Barco {
    ...
    private boolean verificarSiguienteMovimiento() {
        System.out.println("verificarSiguienteMovimiento\n");
...
/*
 * public void colocarPartes() { Tablero tablero = Tablero.getTablero(); for (int i = 0; i <
 * tamanio; i++) { // System.out.println(tamanio); Vector vector = new Vector(posicion.x(),
 * posicion.y()); (partesDelBarco.get(i)).cambiarPosicion(vector.suma(orientacion.porEscalar(i)));
 * tablero.colocarElemento(vector.suma(orientacion.porEscalar(i)), partesDelBarco.get(i)); } } }
 */