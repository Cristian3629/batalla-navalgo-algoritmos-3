...
public class BuqueTest {
	 ...
	 * { MovimientoLinealStrategy estrategia = new MovimientoLinealStrategy(new
	 * Vector(1, 1)); Vector orientacion = new Vector(1, 0); Buque buque = new
	 * Buque(orientacion, estrategia); estrategia.setBarco(buque);
	 * 
	 ...
	 * 
	 * @Test public void
	 * testParaComprobarQueSeInvierteCorrectamenteElMovimiento() {
	 * MovimientoLinealStrategy estrategia = new MovimientoLinealStrategy(new
	 * Vector(1, 1)); Vector movimientoInvertido = new Vector(-1, -1); Vector
	 * orientacion = new Vector(1, 0); Buque buque = new Buque(orientacion,
	 * estrategia); estrategia.setBarco(buque);
	 * 
	...
	public void testParaComprobarQueLasPartesSeEncuentranEnLasNuevasPosiciones() {
		...
		assertTrue(tablero.elementoPerteneceAlCasillero(posicion1,
				partes.get(0)));
		assertTrue(tablero.elementoPerteneceAlCasillero(posicion2,
				partes.get(1)));
		assertTrue(tablero.elementoPerteneceAlCasillero(posicion3,
				partes.get(2)));
		assertTrue(tablero.elementoPerteneceAlCasillero(posicion4,
				partes.get(3)));
	}
	...
	public void testParaComprobarCuandoSeColocaSoloSeEncuentraUnaParteEnCadaPosicion() {
		...
		assertEquals(
				...
				false);
		assertEquals(
				tablero.elementoPerteneceAlCasillero(posicion0, partes.get(3)),
				false);
		...
		assertEquals(
				...
				false);
		assertEquals(
				tablero.elementoPerteneceAlCasillero(posicion1, partes.get(3)),
				false);
		...
		assertEquals(
				...
				false);
		assertEquals(
				tablero.elementoPerteneceAlCasillero(posicion2, partes.get(3)),
				false);

		assertEquals(
				tablero.elementoPerteneceAlCasillero(posicion3, partes.get(0)),
				false);
		assertEquals(
				tablero.elementoPerteneceAlCasillero(posicion3, partes.get(1)),
				false);
		assertEquals(
				tablero.elementoPerteneceAlCasillero(posicion3, partes.get(2)),
				false);
