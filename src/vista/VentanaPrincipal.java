...
public class VentanaPrincipal implements MouseListener {
	...
	private void initialize() throws IOException {
		...
		JButton btnIniciar = this.addBotonIniciar(posicion, posicionY, tamX,
				tamY);

		posicionY += tamY;

		JButton btnDetener = this.addBotonDetener(posicion, posicionY, tamX,
				tamY);
		...
		posicionY1 += tamY;
		JButton btnMina1 = this
				.addBotonMina1(posicionX, posicionY1, tamX, tamY);

		posicionY1 += tamY;
		JButton btnMina2 = this
				.addBotonMina2(posicionX, posicionY1, tamX, tamY);
	...
	private JButton addBotonMina2(int posicionX, int posicionY, int tamX,
			int tamY) {
		ImageIcon iconoMinaRadio2 = new ImageIcon(
				"imagenes/iconos/mina_radio2.png");
	...
	private JButton addBotonMina1(int posicionX, int posicionY, int tamX,
			int tamY) {
		ImageIcon iconoMinaRadio1 = new ImageIcon(
				"imagenes/iconos/mina_radio1.png");
	...
	private JButton addBotonMina(int posicionX, int posicionY, int tamX,
			int tamY) {
		ImageIcon iconoMinaRadio = new ImageIcon(
				"imagenes/iconos/mina_contacto.png");
	...
	private JButton addBotonDisparar(int posicionX, int posicionY, int tamX,
			int tamY) {
	...
	private void inicializarModelo() throws IOException {
		 ...
		 * Partida(nodoPartida); ArrayList<Barco> barcos =
	...
	private JButton addBotonDetener(int posicionX, int posicionY, int tamX,
			int tamY) {
		// I
	...
	private JButton addBotonPasarTurno(int posicionX, int posicionY, int tamX,
			int tamY) {
		ImageIcon iconoPasarTurno = new ImageIcon(
				"imagenes/iconos/pasar_turno.png");
	...
	private JButton addBotonIniciar(int posicionX, int posicionY, int tamX,
			int tamY) {
