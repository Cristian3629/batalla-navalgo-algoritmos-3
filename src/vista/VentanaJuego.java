...
public class VentanaJuego extends Ventana implements Observador {
	...
	private JButton addBotonMina2(int posicionX, int posicionY) {
		BotonJuego btnMina2 = new BotonJuego(posicionX, posicionY,
				"imagenes/iconos/mina_radio2.png", "Mina Radio 2 | Costo: 100");
	...
	private JButton addBotonMina(int posicionX, int posicionY) {
		BotonJuego btnMina = new BotonJuego(posicionX, posicionY,
				"imagenes/iconos/mina_contacto.png",
				"Mina Contacto | Costo: 150");
	...
	private JButton addBotonMina1(int posicionX, int posicionY) {
		BotonJuego btnMina1 = new BotonJuego(posicionX, posicionY,
				"imagenes/iconos/mina_radio1.png", "Mina Radio 1 | Costo: 50");
	...
	private JButton addBotonDisparar(int posicionX, int posicionY) {
		BotonJuego btnDisparar = new BotonJuego(posicionX, posicionY,
				"imagenes/iconos/disparo.png", "Disparar | Costo: 200");
	...
	private JButton addBotonPasarTurno(int posicionX, int posicionY) {
		BotonJuego btnPasarTurno = new BotonJuego(posicionX, posicionY,
				"imagenes/iconos/pasar_turno.png", "Pasar Turno | Costo: 10");
	...
	public void verificarFinDelJuego() {
		if (partida.gano()) {
			VentanaFondo ventana = new VentanaFondo("VICTORIA",
					"imagenes/gano.png");
		...
		if (partida.perdio()) {
			VentanaFondo ventana = new VentanaFondo("DERROTA",
					"imagenes/perdio.png");
			ventana.setVisible(true);
			frame.dispose();
		}
	...
	private JButton addBotonIniciar(int posicionX, int posicionY) {
		BotonJuego btnIniciar = new BotonJuego(posicionX, posicionY,
