...
public class MinaDobleRadioTest {
	...
	@Test
	public void testCreoUnaMinaDobleRadioCercaDeUnaParteYAlExplotarDeberiaDaniarla() {
	...
	@Test
	public void testCreoUnaMinaDobleRadioFueraDeSuRangoYAlExplotarNoDeberiaVerseAfectada() {
		MinaDobleRadio mina = new MinaDobleRadio();
		Vector posicion = new Vector(3, 3);
		mina.cambiarCasillerosAfectados(posicion);
		Vector posicionNoPertenecienteAlRadio = new Vector(6, 6);
		Parte parte = new Parte(1);
		Tablero tablero = Tablero.getTablero();
