...
public class VentanaJuego extends Ventana implements Observador {
    ...
    private JLabel addTurno() {
        JLabel unTurno = new JLabel("Turno: " + Integer.toString(this.numeroTurno));
    ...
    private void notificarCantidadDePuntosInsuficientes() {
        JOptionPane.showMessageDialog(null, "Puntos insuficientes: el arma que intentas utilizar cuesta más puntos que los que tienes.");
    }
    ...
    private JButton addBotonMina2(int posicionX, int posicionY) {
        Boton btnMina2 = new Boton("imagenes/iconos/minaradio2.png", posicionX, posicionY);
    ...
    private JButton addBotonMina(int posicionX, int posicionY) {
        Boton btnMina = new Boton("imagenes/iconos/minacontacto.png", posicionX, posicionY);
    ...
    private JButton addBotonMina1(int posicionX, int posicionY) {
        Boton btnMina1 = new Boton("imagenes/iconos/minaradio1.png", posicionX, posicionY);
    ...
    private JButton addBotonDisparar(int posicionX, int posicionY) {
        Boton btnDisparar = new Boton("imagenes/iconos/disparar.png", posicionX, posicionY);
    ...
    private void inicializarModelo(String dirArchivo) throws IOException {
        ...
        if (!dirArchivo.equals("")) {
            ...
            this.vistasDaniadores = vistasDaniadores;
            Iterator<VistaDaniador> it = vistasDaniadores.iterator();
            while (it.hasNext()) {
                it.next().agregarObservador(this);
            }
        } else {
            partida = new Partida();
